...
/**
 * Page format.
 * Changed from A4 to custom array for 210x70mm
 */
define ('PDF_PAGE_FORMAT', array(210, 70));

/**
 * Page orientation (P=portrait, L=landscape).
 * Changed from P to L for landscape
 */
 ...
 * Changed from helvetica to dejavusans for better character support
 */
 ...
 * Changed from helvetica to dejavusans
 */
